...
$(document).ready(function () {
    ...
    PieHub.init({
        pieid: 38, // parseInt(window.location.pathname.split('pie/')[1]),
    ...
    // create a Mapnik tile layer
    var mapnik = new L.TileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {maxZoom: 18, attribution: 'Map data &copy; 2011 OpenStreetMap contributors'});

    // initialize the map on the "map" div
    var map = new L.Map('llmap');
    ...
    var p2 = new L.LatLng(51.503, -0.06);
    ...
    $('#bzoomp').button();
    $('#bzoomp').click( function () { llmap.zoomIn(); } );
    $('#bzoomm').button();
    $('#bzoomm').click( function () { llmap.zoomOut(); } );
