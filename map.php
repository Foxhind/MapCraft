...
kmllayer = new OpenLayers.Layer.Vector("Pies", { strategies: [new OpenLayers.Strategy.Fixed()], protocol: new OpenLayers.Protocol.HTTP({url: "http://mapcraft.nanodesu.ru/json_pies.php", format: new OpenLayers.Format.GeoJSON() })});
