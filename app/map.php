...
kmllayer = new OpenLayers.Layer.Vector("Cakes", { strategies: [new OpenLayers.Strategy.Fixed()], protocol: new OpenLayers.Protocol.HTTP({url: "/app/json_pies.php", format: new OpenLayers.Format.GeoJSON() })});
